...
In the [demo](http://github.com/jojoxd/heketi/wiki/Demo),
...
[client/cli/go/topology-sample.json](https://github.com/jojoxd/heketi/blob/master/client/cli/go/topology-sample.json)
